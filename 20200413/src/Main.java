...
/**木棒拼图
 * 链接：https://www.nowcoder.com/questionTerminal/8bbc9415216d47459c425b5e19164365?f=discussion
 * 来源：牛客网
 *
...
public class Main {
    ...
    private static void res(int n, int[][] arr) {
    ...
    private static boolean isPoly(ArrayList<Integer> list) {
        int len = list.size();
        for (int i = 0;i < len;i++){
